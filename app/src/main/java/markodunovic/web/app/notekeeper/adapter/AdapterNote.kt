...
class AdapterNote(private val noteList:List<Note>,private val context: Context, private val adapterOnClickListener: AdapterOnClickListener)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AdapterNoteViewHolder {
        val view:View = LayoutInflater.from(parent.context).inflate(R.layout.card_cycler,parent,false)
